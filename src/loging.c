...
int main(int argc, char *argv[] ) {
  ...
  if (argc == 1) {
    ...
    printf("| Vorläufige Syntax: ./encoder  -delay [ms] -mult [mul] -l [y|n] |\n");
    printf("| delay = 10ms<delay<40000                                       |\n");
    printf("| Zukünftig kann das Resultat in eine Textdatei                  |\n");
    printf("| geschrieben werden.                                            |\n");
    printf("+----------------------------------------------------------------+\n");
    return 0;
  }
  if (argc != 8) {
  ...
  /*if (strcmp("-delay",argv[1])!=0 || strcmp("-mult",argv[3])!=0 || strcmp("-l",argv[5])!=0) {
    printf("Bitte folgende Werte angeben: \n");
    printf("./encoder -delay [ms] -mult [mult] -l [y|n]\n");
    return 0;
    }*/  
  ...
  if (strcmp("y", argv[6])==0)
    {
      ...
      modbus_set_response_timeout(ctx, &response_time);
      withLoad(argv);
    }
  else
    withoutLoad(argv);
