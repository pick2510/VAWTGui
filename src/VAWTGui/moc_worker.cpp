...
QT_MOC_LITERAL(4, 27, 12), // "execFinished"
QT_MOC_LITERAL(5, 40, 9) // "startWork"

    },
    "Worker\0resultReady\0\0result\0execFinished\0"
    "startWork"
};
...
void Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Worker::execFinished)) {
                *result = 1;
                return;
            }
        }
